...
/***/ function(module, exports, __webpack_require__) {
	...
	var List = React.createClass({
	  ...
	  render: function render() {
	    ...
	    var listItems = this.props.items.map(function (item, idx) {
	      return React.createElement(
	        'li',
	        { key: idx, className: 'list-group-item', style: styles.listGroup },
	        React.createElement('span', {
	          className: 'glyphicon glyphicon-remove',
	          style: styles.removeItem,
	          onClick: _this.props.remove.bind(null, idx) }),
	        React.createElement(
	          'span',
	...
	var ListContainer = React.createClass({
	  ...
	  handleRemoveItem: function handleRemoveItem(idx) {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement('input', { type: 'text', value: name, onChange: this.handleName })
	        )
	      ),
	      React.createElement(
	        'h2',
	...
	React.render(React.createElement(ToDo, null), document.querySelector('.container'));
